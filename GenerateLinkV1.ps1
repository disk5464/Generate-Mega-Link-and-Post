<#
This script will take a folder path and generate a link for all the folders within it and then put thoes links into a persistent file.
...
if ($IsWindows) 
{
    start $FilePath\links.txt
}
else 
{
    open $FilePath\links.txt
}
